...
public class AeolianNoteScaleBuilder implements NoteScaleBuilder {
    ...
    public List<NoteQualifier> getNoteScale(NoteLetter letter, int octave) {
        ...
        NoteQualifier third = Notes.getNoteQualifier(tonic, Interval.MINOR_THIRD);
        ...
        NoteQualifier sixth = Notes.getNoteQualifier(tonic, Interval.MINOR_SEXTH);
        NoteQualifier seventh = Notes.getNoteQualifier(tonic, Interval.MINOR_SEXTH);
